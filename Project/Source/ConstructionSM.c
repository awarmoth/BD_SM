/****************************************************************************
 ...
 Description
   This is the state machine for constructing. It is at the first level in MasterHSM
 ...
 When           Who     What/Why
 -------------- ---     --------
 02/16/17 23:00 asw      Began converting Template
****************************************************************************/
/*----------------------------- Include Files -----------------------------*/
...
static ConstructionState_t CurrentState;
...
ES_Event RunConstructionSM( ES_Event CurrentEvent )
{
   ...
   ConstructionState_t NextState = CurrentState;
   ...
   switch ( CurrentState )
   {
    ...
    if (MakeTransition == true)
    {
       ...
       RunConstructionSM(CurrentEvent);

       CurrentState = NextState; //Modify state variable

       //   Execute entry function for new state
       // this defaults to ES_ENTRY
       RunConstructionSM(EntryEventKind);
     }
     return(ReturnEvent);
}
/****************************************************************************
