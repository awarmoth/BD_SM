/****************************************************************************
 ...
 Description
   This is the event checkers including checking the state of various sensor inputs
	 and checking for keystrokes to aid in debugging
 ...
 When           Who     What/Why
 -------------- ---     --------
 02/16/17 21:23 asw     initial version: modifying template
****************************************************************************/
